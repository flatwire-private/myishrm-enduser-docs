...
**Primary Responsibility:** Review applications and generate invoices
...
3. You'll see the Admission Dashboard
...
- **Approved Applications** - Applications with generated invoices
- **Statistics** - Total applications by status
...
2. Configure the invoice:
   ```
   Invoice Items (Add/Remove as needed):
   - Admission Fee: ₱2,000
   - Registration Fee: ₱1,500
   - Add other fees as required

   Due Date: Select (3, 7, 14, or 30 days)

   Remarks (optional): Any special notes
   ```
...
2. See all generated invoices with:
   - Invoice number
   - Applicant name
   - Total amount
   - Payment status
...
- **Paid** - Payment verified by accounting
...
After generating an invoice, you can:
1. View the applicant's page
...
[YOU: Review Application]
   ↓
[YOU: Approve & Generate Invoice]
   ↓
Applicant Pays & Uploads Proof
   ↓
...
3. **Due Dates** - Standard is 7 days, adjust based on circumstances
4. **Communication** - Add remarks to invoice for special instructions
...
**Q: What if applicant doesn't pay?**
A: You can see overdue invoices. Follow up with applicant via their contact information.

**Q: Can I convert applicant to student?**
A: No, only the [Registrar](registrar.md) can convert applicants after payment is verified.

**Q: What if documents are unclear?**
A: Contact the applicant and ask them to re-upload clear documents before approving.
